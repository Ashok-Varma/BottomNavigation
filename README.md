...
or Gradle:
```groovy
compile 'com.ashokvarma.android:bottom-navigation-bar:2.0.5'
```
or Ivy:
```xml
<dependency org='com.ashokvarma.android' name='bottom-navigation-bar' rev='2.0.5'>
...
3. [SharedPrefManager](https://github.com/Ashok-Varma/SharedPrefManager) : SharedPref Manager is a Dev Debug tool that helps to manage(Edit, Add, Clear) your android Shared Preferences.
 ...
 [mavenAarDownload]:  https://repo1.maven.org/maven2/com/ashokvarma/android/bottom-navigation-bar/2.0.5/bottom-navigation-bar-2.0.5.aar
